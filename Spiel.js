...
function Zug1() {
  ...
  if (dec1 != 1 || dec1  != 2 || dec1!= 3 || dec1 !=4 || dec1  != 5 || dec1!= 6 || dec1 !=7 || dec1  != 8 || dec1!= 9 || arr[dec1] === "x" || arr[dec1] === "o") { //if (dec1 != 1 || dec1  != 2 || dec1!= 3 dec1 !=4 || dec1  != 5 || dec1!= 6 dec1 !=7 || dec1  != 8 || dec1!= 9 )
    console.log("");
...
function Zug2() {
  ...
  if (dec2 != 1 || dec2  != 2 || dec2!= 3 || dec2 !=4 || dec2  != 5 || dec2!= 6 || dec2 !=7 || dec2  != 8 || dec2!= 9 || arr[dec2] === "x" || arr[dec2] === "o") {
    console.log("");
    console.log("Bitte gebe eine gültige Position ein! ");
    console.log("");
    return Zug2();
